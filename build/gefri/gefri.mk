...
$(IntermediateDirectory)/geometry_gxRect$(ObjectSuffix): ../../src/core/geometry/gxRect.cpp $(IntermediateDirectory)/geometry_gxRect$(DependSuffix)
	$(CompilerName) $(SourceSwitch) "Z:/gefri/src/core/geometry/gxRect.cpp" $(CmpOptions) $(ObjectSwitch)$(IntermediateDirectory)/geometry_gxRect$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/geometry_gxRect$(DependSuffix): ../../src/core/geometry/gxRect.cpp
	@$(CompilerName) $(CmpOptions) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/geometry_gxRect$(ObjectSuffix) -MF$(IntermediateDirectory)/geometry_gxRect$(DependSuffix) -MM "Z:/gefri/src/core/geometry/gxRect.cpp"

$(IntermediateDirectory)/geometry_gxRect$(PreprocessSuffix): ../../src/core/geometry/gxRect.cpp
	@$(CompilerName) $(CmpOptions) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/geometry_gxRect$(PreprocessSuffix) "Z:/gefri/src/core/geometry/gxRect.cpp"
